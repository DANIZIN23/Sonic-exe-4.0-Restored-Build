...
function onStepHit()
    for BeatsHit = 1,#BeatPorcent do
        if FourPorcent == true and (curStep/4) % 4 == BeatPorcent[BeatsHit] or FourPorcent == false and (curStep/4) % BeatPorcent[BeatsHit] == 0 then
...
function clearBeat()
    for clearCanBeat = 2,#BeatPorcent do
