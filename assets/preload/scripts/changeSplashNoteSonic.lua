...
function onCreatePost()
	...
	if string.match(songName,'substantial')  == 'substantial' then
		textureSplash = 'noteSplashesDefault'
		defaultSplashX = 120
		defaultSplashY = 120
	end
	if string.match(songName,'digitalized')  == 'digitalized' then
		textureSplash = 'noteSplashesDefault'
		defaultSplashX = 120
		defaultSplashY = 120
	end
	if string.match(songName,'hollow')  == 'hollow' then
		textureSplash = 'noteSplashesDefault'
		defaultSplashX = 120
		defaultSplashY = 120
	end
	if string.match(songName,'b4cksl4sh')  == 'b4cksl4sh' then
		textureSplash = 'noteSplashesPixel'
		defaultSplashX = 100
		defaultSplashY = 100
	end
	if songName == 'my-horizon-pixel' then
			textureSplash = 'noteSplashesPixel'
			defaultSplashX = 100
			defaultSplashY = 100
	end
	if string.match(songName,'Prey')  == 'Prey' then
		textureSplash = 'noteSplashesPixel'
		defaultSplashX = 100
		defaultSplashY = 100
	end
	if string.match(songName,'Fatality')  == 'Fatality' then
		textureSplash = 'noteSplashesPixel'
		defaultSplashX = 100
		defaultSplashY = 100
	end
	if string.match(songName,'Fatality-ez')  == 'Fatality-ez' then
		textureSplash = 'noteSplashesPixel'
		defaultSplashX = 100
		defaultSplashY = 100
	end
...
function onStepHit()
	if curStep == 528 and songName == 'you-cant-run' or curStep == 528 and songName == 'you-cant-run-encore' then
		enableNewSystem = 2
		textureSplash = 'noteSplashesPixel'
		defaultSplashX = 100
		defaultSplashY = 100
	end
	if curStep == 784 and songName == 'you-cant-run' or curStep == 784 and songName == 'you-cant-run-encore' then
		enableNewSystem = 2
		textureSplash = 'BloodSplash'
		defaultSplashX = 70
		defaultSplashY = 35
	end
