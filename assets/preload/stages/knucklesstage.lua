function onCreate()
	-- background shit
	makeLuaSprite('broken', 'my-horizon/broken', -1320, -400);
	setScrollFactor('broken', 1.0, 1.0);
	scaleObject('broken', 1.2, 1.2);

	makeLuaSprite('bigmountain', 'my-horizon/bigmountain', -590, -400);
	setScrollFactor('bigmountain', 0.8, 0.8);
	scaleObject('bigmountain', 1.2, 1.2);

	makeLuaSprite('knucklesnight', 'my-horizon/knucklesnight', -570, -270);
	setScrollFactor('knucklesnight', 0.7, 0.7);
	scaleObject('knucklesnight', 1.2, 1.2);

	makeLuaSprite('master', 'my-horizon/master', -560, -300);
